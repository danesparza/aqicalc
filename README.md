# aqicalc [![Build and Tests](https://github.com/danesparza/aqicalc/actions/workflows/release.yaml/badge.svg)](https://github.com/danesparza/aqicalc/actions/workflows/release.yaml)
